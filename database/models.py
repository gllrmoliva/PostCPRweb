...
class Student(Base):
    ...
    course = relationship("Course", secondary="student_course", back_populates="student")
class Course(Base):
    ...
    student = relationship("Student", secondary="student_course", back_populates="course")
...
class Review(Base):
    ...
    submission_id = Column(Integer, ForeignKey('submission.submission_id'), nullable=False)
    submission = relationship("Submission")
    criterion = relationship("Criterion",secondary="review_criterion",back_populates="review")
