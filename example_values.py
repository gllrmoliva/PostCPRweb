...
def insert_default_values(database):
    ...
    # Pedro hizo la primera tarea de fisica y Jack la revisó
    ...
    r4_cr1 = CriterionReview(criterion=criterio_f1_1, review=revision_jack_a_pedro, score=0.1)
    r4_cr2 = CriterionReview(criterion=criterio_f1_2, review=revision_jack_a_pedro, score=0.2)
    r4_cr3 = CriterionReview(criterion=criterio_f1_3, review=revision_jack_a_pedro, score=0.3)
